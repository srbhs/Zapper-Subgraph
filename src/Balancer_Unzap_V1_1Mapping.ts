...
export function handleOwnershipTransferredEvent(
  ...
  let entity = new Balancer_Unzap_V1_1OwnershipTransferredEvent(
...
export function handleZapoutEvent(event: ZapoutEvent): void {
  let entity = new Balancer_Unzap_V1_1ZapoutEvent(
    event.transaction.hash.toHex() + "-" + event.logIndex.toString()
  )
  entity.fromAddress = event.transaction.from
  entity.toAddress = event.transaction.to
...
export function handleEasyZapOutCall(call: EasyZapOutCall): void {
  ...
  let entity = new Balancer_Unzap_V1_1EasyZapOutCall(id)
...
export function handleZapOutCall(call: ZapOutCall): void {
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1ZapOutCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.slippage = call.inputs.slippage
...
export function handledestructCall(call: DestructCall): void {
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1destructCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
...
export function handleinCaseTokengetsStuckCall(
  ...
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1inCaseTokengetsStuckCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
...
export function handlerenounceOwnershipCall(call: RenounceOwnershipCall): void {
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1renounceOwnershipCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
...
export function handlesetnewdzgoodwillAddressCall(
  ...
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1setnewdzgoodwillAddressCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
...
export function handlesetnewgoodwillCall(call: SetnewgoodwillCall): void {
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1setnewgoodwillCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
...
export function handletoggleContractActiveCall(
  ...
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1toggleContractActiveCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
...
export function handletransferOwnershipCall(call: TransferOwnershipCall): void {
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1transferOwnershipCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
...
export function handleupdateSlippageCall(call: UpdateSlippageCall): void {
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1updateSlippageCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
...
export function handlewithdrawCall(call: WithdrawCall): void {
  let id = call.transaction.hash.toHex()
  let entity = new Balancer_Unzap_V1_1withdrawCall(id)
  entity.fromAddress = call.transaction.from
  entity.toAddress = call.transaction.to
  entity.blockTimestamp = call.block.timestamp
  entity.save()
