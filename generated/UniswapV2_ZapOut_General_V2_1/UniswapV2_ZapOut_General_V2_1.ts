...
export class UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenWithPermitResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniswapV2_ZapOut_General_V2_1 extends ethereum.SmartContract {
  static bind(address: Address): UniswapV2_ZapOut_General_V2_1 {
    return new UniswapV2_ZapOut_General_V2_1(
  ...
  ZapOut2PairToken(
    _FromUniPoolAddress: Address,
    _IncomingLP: BigInt
  ): UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenResult {
    let result = super.call(
      "ZapOut2PairToken",
    ...
    return new UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  > {
    ...
    return ethereum.CallResult.fromValue(
      new UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  ZapOut2PairTokenWithPermit(
    ...
    r: Bytes,
    s: Bytes
  ): UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenWithPermitResult {
    let result = super.call(
      "ZapOut2PairTokenWithPermit",
    ...
    return new UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenWithPermitResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  > {
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapV2_ZapOut_General_V2_1__ZapOut2PairTokenWithPermitResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
