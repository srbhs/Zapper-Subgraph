...
export class UniSwapRemoveLiquityGeneral_v1 extends ethereum.SmartContract {
  static bind(address: Address): UniSwapRemoveLiquityGeneral_v1 {
    return new UniSwapRemoveLiquityGeneral_v1(
